...
import 'package:study_buddy/screens/groups_screen/group_chat_screen.dart';
      ...
      trailing: InkWell(
        onTap: () async {
          ...
          if (isJoined) {
            ...
            snackBar(context, "Successfully joined the group", 'green');
            ...
            setState(() {
              isJoined = !isJoined;
              snackBar(context, "Left the group $groupName", 'red');
            });
          }
        },
        child: isJoined
